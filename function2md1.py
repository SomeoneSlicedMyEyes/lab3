...
result = is_highly_rated(example)
print(result)
#2
def print_highly_rated_movies(movie_list):
...
print_highly_rated_movies(movies)
...
print(f"Movies under the category '{category}':")
...
print(f"Average IMDB score of the movies: {average:.2f}")
...
average_imdb_in_category = average_imdb_by_category(movies, category_name)
print(f"Average IMDB score of {category_name} movies: {average_imdb_in_category:.2f}")
